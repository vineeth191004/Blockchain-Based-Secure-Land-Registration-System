...
export default function MRODashboard() {
    ...
    const fetchApplications = async () => {
        try {
            // Get applications that need revenue department verification
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-linear-to-br from-red-900 to-slate-900">
                <DashboardHeader
                    title="Loading..."
                    subtitle="Please wait"
                    officialName={auth.getUser()?.name || ''}
                    designation="MRO Officer"
                />
            ...
            <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden">
                    <div className="px-6 py-4 border-b border-white/20">
                        <h3 className="text-lg font-semibold text-white">Applications Pending Revenue Verification</h3>
                        <p className="text-sm text-gray-300 mt-1">
                            Review and verify land registration applications for revenue compliance
                        </p>
                    </div>
                                ...
                                {applications.length === 0 && (
                                    <tr>
                                        <td colSpan={7} className="px-6 py-8 text-center text-gray-400">
                                            No applications pending revenue verification.
                                        </td>
                                    </tr>
                                )}
                            </tbody>
                        ...
                        <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                <h3 className="text-xl font-semibold text-gray-900 mb-4">
                                    Revenue Department Review - {selectedApp.applicationId}
                                </h3>
                                ...
                                <div className="bg-yellow-50 p-4 rounded-lg mb-6">
                                    <h4 className="text-sm font-medium text-yellow-800 mb-2">Revenue Department Checklist</h4>
                                    <ul className="text-sm text-yellow-700 space-y-1">
                                        <li>• Verify land ownership documents</li>
                                        <li>• Check for any revenue dues</li>
                                        <li>• Confirm survey number accuracy</li>
                                        <li>• Validate land classification</li>
                                    </ul>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    >
                                        {verifying ? 'Verifying...' : 'Verify for Revenue Dept'}
                                    </button>
                                    <button
